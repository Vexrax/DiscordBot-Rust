...
pub async fn run(_options: &[ResolvedOption<'_>], ctx: &Context, command: &CommandInteraction) {
    ...
    for riot_summoner in summoners {
        ...
        let match_embed = build_embed(riot_summoner, match_players);
...
fn build_embed(main_player_riot_summoner: Summoner, match_players: Vec<MatchPlayer>, ) -> CreateEmbed {
    ...
    let embed = CreateEmbed::new()
        ...
        .description(&format!("In game for TODO minutes"))
